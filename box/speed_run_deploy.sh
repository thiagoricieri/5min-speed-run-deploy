...
echo "2. Copy the public key to your GitHub account: GitHub → Settings → SSH and GPG Keys"
echo "cat ~/.ssh/deployer.pub | pbcopy"
echo "3. Add new SSH Key and paste the contents in Key field"
echo "4. Copy the private key contents (it was created in ~/.ssh/deployer in your machine):"
echo "cat ~/.ssh/deployer | pbcopy"
echo "5. Go to GitHub → Repo Settings → Secrets and Variables → Actions"
echo "6. Create secret SSH_PRIVATE_KEY and paste the private key contents"
echo "7. Create secret: SERVER_IP as $SERVER_IP"
echo "8. Create secret: SERVER_USER as $DEPLOY_USER"
